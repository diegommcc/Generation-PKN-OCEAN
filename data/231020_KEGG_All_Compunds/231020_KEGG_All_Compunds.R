...
while(i <= length(keggId)) {
  ...
  query.list[[paste0("batch.", i)]] <- keggGet(keggId[i:(i+9)])
...
## batch 1: first error
saveRDS(query.list, paste0("/home/diegommcc/Documents/kegg/batch1_", i - 10, ".rds"))
i <- i - 10


saveRDS(query.list, paste0("/home/diegommcc/Documents/kegg/batch2_", i - 10, ".rds"))
i <- i - 10

saveRDS(query.list, paste0("/home/diegommcc/Documents/kegg/ALL_COMPUNDS_KEGG.rds"))


length(query.list[[1]])
length(cmpId)
length(unlist(query.list, recursive = FALSE))
saveRDS(cmpId, paste0("/home/diegommcc/Documents/kegg/compunds_id.rds"))
